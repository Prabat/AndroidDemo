...
import com.mytaxi.android_demo.idlingResource.TestIdlingResource;
...
public class AuthenticationActivity extends AppCompatActivity {
    ...
    private void attemptLogin() {
        if(TestIdlingResource.getInstance() != null)
            TestIdlingResource.getInstance().changeIdleState(false);
        ...
        mHttpClient.fetchUser(RANDOM_USER_SEED, new HttpClient.UserCallback() {
            ...
            public void run() {
                ...
                if (mUser.match(username, sha256)) {
                    ...
                    if(TestIdlingResource.getInstance() != null)
                     TestIdlingResource.getInstance().changeIdleState(true);
                } else {
